class Solution {
    ...
    private int findKthSmallest(int firstArrayStartIndex, int secondArrayStartIndex, int k) {
        ...
        // Compare middle values and eliminate the smaller half
        // The array with smaller middle value cannot contain the k-th smallest element
        // beyond its middle point, so we can safely skip those elements
